...
mod test {
    #[test]
    /// Test for part 1 of Day12 for AoC 2024.
    ...
    fn test_aoc2024_day12_part_1() {
        ...
        let input = r#""#;
        let expected = 42;
        assert_eq!(day12.part_1(input), expected); // Asserts if the function output matches the expected result.
    }

    #[test]
    /// Test for part 2 of Day12 for AoC 2024.
    ...
    fn test_aoc2024_day12_part_2() {
        ...
        let input = r#""#;
        let expected = 42;
        assert_eq!(day12.part_2(input), expected); // Asserts if the function output matches the expected result.
    }
}
