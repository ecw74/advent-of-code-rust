...
mod test {
    ...
    fn test_aoc2024_day01_part_1() {
        ...
        let input = r#""#;
        assert_eq!(day01.part_1(input), "TBD"); // Asserts if the function output matches the expected result.
    }
    ...
    fn test_aoc2024_day01_part_2() {
        ...
        let input = r#""#;
        assert_eq!(day01.part_2(input), "TBD"); // Asserts if the function output matches the expected result.
    }
}
