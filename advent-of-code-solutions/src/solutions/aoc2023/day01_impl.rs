...
impl Day01 {
    ...
    pub fn part_1(&self, input: &str) -> i64 {
        input.split("\n")  // Splitting the input string into lines.
            ...
            .filter_map(|line| {  // Processing each line.
                let digits: Vec<_> = line.chars()  // Collecting all digits in the line.
    ...
    pub fn part_2(&self, input: &str) -> i64 {
        ...
        for (word, replacement) in replacements.iter() {  // Replacing spelled-out numbers.
